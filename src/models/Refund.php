...
class Refund extends Model
{
    ...
    public function validateParentTransactionCorresponds( string $attribute, $params, InlineValidator $validator, $value )
    {
        ...
        if (
            ...
            $validator->addError($this, $attribute, Craft::t('order-refunds',
                'The refund transaction currency must be the same on the refund parent transaction.'));
        }
    ...
    public function getItemSubtotal( bool $inPaymentCurrency = true ): float
    {
        ...
        return $inPaymentCurrency ? $this->paymentAmount($subtotal) : $subtotal;
    }
    ...
    public function getAdjustmentsTotal( bool $inPaymentCurrency = true ): float
    {
        ...
        return $inPaymentCurrency ? $this->paymentAmount($total) : $total;
    }
    ...
    protected function calculateAdjustments(): array
    {
        ...
        foreach ($order->getLineItems() as $lineItem)
        {
            ...
            $subtotal = $lineItem->price * $refundQty;
